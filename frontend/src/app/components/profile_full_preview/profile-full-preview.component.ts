...
@Component({
  selector: 'app-profile-full-preview',
  templateUrl: './profile-full-preview.component.html',
  styleUrls: ['./profile-full-preview.component.sass']
})
export class ProfileFullPreviewComponent {
