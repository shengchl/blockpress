...
@Component({
  selector: 'app-page-profiles-view',
  templateUrl: './page-profiles-view.component.html',
  styleUrls: ['./page-profiles-view.component.sass']
})
export class PageProfilesViewComponent {
