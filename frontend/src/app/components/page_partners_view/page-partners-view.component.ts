...
@Component({
  selector: 'app-page-partners-view',
  templateUrl: './page-partners-view.component.html',
  styleUrls: ['./page-partners-view.component.sass']
})
export class PagePartnersViewComponent {
